...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Boolean> mCardsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrinter = (ImageView) findViewById(R.id.printer_image_view);
        mPrinterCard = (ImageView) findViewById(R.id.printer_card_image_view);
        mPrinterKnob = (LinearLayout) findViewById(R.id.printer_knob);
        mPrinterLight = (LinearLayout) findViewById(R.id.printer_light);
        mYellowLight = true;
        mCanRefresh = true;
        ...
        mProgressBarLeft = (ProgressBar) findViewById(R.id.progress_left);
        mProgressBarRight = (ProgressBar) findViewById(R.id.progress_right);
